...
struct ReportDisclaimerView: View {
    static let reportText = "This report was created from information, notes, photos and documents added by the user. Rentory does not provide legal, financial, tenancy, claims-management or dispute-resolution advice."
